...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String _userType = 'pharmacy'; // pharmacy or company
  ...
  Future<void> _register() async {
    ...
    if (_passwordController.text != _confirmPasswordController.text) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('كلمة المرور غير متطابقة'), backgroundColor: Colors.red),
      );
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('تم إنشاء الحساب بنجاح! سيتم مراجعة طلبك قريباً'),
